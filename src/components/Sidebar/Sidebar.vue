    ...
    >
      ...
      <ul class="nav">
        ...
        <NavLink
              ...
              { header: '部门管理', link: '/manage/manageDepartment' },
        ...
        <NavLink
                ...
                index="components"
                :childrenLinks="[
              { header: '部门管理', link: '/manage/departmentList' },
              { header: '部门详情', link: '/manage/viewDepartment' },
              { header: '部门分类', link: '/manage/Sectordepartment' },
            ]"
        />
        <NavLink
                :activeItem="activeItem"
