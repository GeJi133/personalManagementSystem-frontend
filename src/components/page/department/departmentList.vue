            ...
            <b-modal @ok="handleOk1" :id="`model-20`" title="添加部门">
              ...
              <form class="mt" ref="form">
                ...
                <div class="form-group">
                  <p class="widget-auth-info">部门编号：</p>
                  <input
                    @change="checkDno()"
                    class="form-control no-border"
                    v-model="addDepartment.dno"
                    placeholder="部门名"
                  />
                </div>
                <!--       -->
                <div class="form-group">
                  <p class="widget-auth-info">部门名称：</p>
                  <input
                    class="form-control no-border"
                    v-model="addDepartment.department"
                    placeholder="部门名"
                  />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input
                    class="form-control no-border"
                    v-model="addDepartment.business"
                    placeholder="部门业务"
                  />
                </div>
                ...
                <div class="form-group">
                  <div>
                    <p class="widget-auth-info">部门经理：</p>
                    <b-form-select
                      class="form-control no-border"
            ...
            <table class="table table-striped table-lg mb-0 requests-table">
              ...
              <tbody>
                <tr v-for="department in departments" :key="department.dno">
                  ...
                  <td>
                    <a href="#" @click="viewDepartment(department.dno)">{{department.department}}</a>
                  </td>
                  <td>
                  ...
                  <td style="width: 80px">
                    <p>
                      <b-button
                        ...
                        v-b-modal="`model-2${department.dno}`"
                      >修改</b-button>
                    </p>
                    <b-modal @ok="handleOk(department)" :id="`model-2${department.dno}`" title="修改部门信息">
                      <!--            <Widget class="widget-auth mx-auto" title="<h3 class='mt-0'>Login to your Web App</h3>" customHeader>-->
                      部门编号：
                      <p class="widget-auth" v-model="editDepartment.dno">{{department.dno}}</p>
                      <form class="mt" ref="form" @submit.stop.prevent="manage(this.jobInfo.jno)">
                        ...
                        <div class="form-group">
                          ...
                          <input
                            class="form-control no-border"
                            v-model="editDepartment.department"
                            placeholder="部门名"
                          />
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input
                            class="form-control no-border"
                            v-model="editDepartment.business"
                            placeholder="部门业务"
                          />
                        </div>
                        ...
                        <div class="form-group">
                          <div>
                            ...
                            <b-form-select
                              class="form-control no-border"
                              v-model="editDepartment.manager"
                              :options="options"
                            ></b-form-select>
                            <div class="mt-3">
                              Selected:
                  ...
                  <td>
                    <p>
                      <b-button
                              variant="default" class="mr-xs" size="sm"
                        v-b-modal="`model-3${department.dno}`"
                      >删除</b-button>
                    </p>
                    <b-modal
                      @ok="deleteDepartment(department.dno)"
                      :id="`model-3${department.dno}`"
                      title="提示"
                    >
                      <!--            <Widget class="widget-auth mx-auto" title="<h3 class='mt-0'>Login to your Web App</h3>" customHeader>-->
...
export default {
  ...
  methods: {
    ...
    checkDno() {
      let departmentId=this.addDepartment.dno;
      console.log(departmentId);
