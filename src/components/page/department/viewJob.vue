<template>
  <div class="page">
    ...
    <b-row>
      <b-col xs="12" lg="8">
        <Widget title="<h6>  </h6>" close collapse settings customHeader>
          <b-row>
            <b-col lg="5" xs="12">
              <h5 class="m-t-1">岗位名</h5>
              <p>
                岗位简介：There are few position options available for notifications. You can click any of
                them
              ...
              <p>
                部门简介：There are few position options available for notifications. You can click any of
                them
                to change notifications position:
              </p>
            </b-col>
            <b-col lg="6" xs="12">
              ...
              <p>
                <b-button variant="info" id="show-info-message" v-b-modal.modal-1>
                  Info
                  Message
                </b-button>
              </p>
              <b-modal id="modal-1" title="修改岗位信息">
                ...
                <p class="widget-auth-info">修改岗位基本信息.</p>
              ...
              <p>
                <b-button variant="danger" id="show-error-message" @click="addErrorNotification">
                  Error
                  Message
                </b-button>
              </p>
            ...
            <table class="table">
              ...
              <tbody>
                <tr v-for="staff in personList" :key="staff.id">
                  <td>
                    <a href="#" @click="viewStaff(staff.id)">{{staff.id}}</a>
                  </td>
                  <td>
